...
Technical Data: Basic browser information required for the extension to function and communicate with our API.

User Preferences: Tags or "styles" you explicitly save within the extension to refine your gift graph.

3. How We Use Your Data
We use the collected information solely to:

Construct a private "Knowledge Graph" of aesthetic preferences to generate accurate gift suggestions.

Match Pinterest visual data with product listings on third-party marketplaces (e.g., Amazon).

Improve the recommendation algorithm of the extension.
...
Pinterest API: To retrieve your curated content.

AI Processing: Image data may be processed by AI models (such as OpenAI or Google Gemini) to identify object attributes.

Affiliate Networks: We may display links to retailers. If you click these, those retailers may use cookies to track the referral.
